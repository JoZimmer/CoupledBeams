...
params_dict = {
    ...
    "lasten":{
        ...
        "kopflasten":{
            ...
            "skalierungs_rotor_flaechen":[707,13273, 2],
    ...
    "vorspannung":{
        ...
        "n_segmente_extern":1, #n_segmente_ext: Anzahl der Segmente die durch Externe Vorspannung Überdrückt sein sollen: Inklusive der Fuge Übergnag stahl holz
