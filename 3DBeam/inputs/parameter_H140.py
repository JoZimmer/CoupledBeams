...
params_dict = {
    ...
    "lasten":{
        ...
        "kopflasten":{
            ...
            "lastwerte":{ '@max_Fxy':{'Fx':1.17E+06,'Fy':4.80E+04, 'Fz':-3.64E+06, 'Mx':5.98E+06, 'My':6.81E+06, 'Mz':2.31E+06},# NOTE My = Mxy #Masse charakt. 2.62E+06, Fx = Fxy 
    ...
    "vorspannung":{
        ...
        "n_segmente_extern":3,
        "inkl_fuß_ext":False, # ob auch die Kraft am Fuß des n_exten segments durch die externe Vorspannung abgedeckt werden soll (als n_segmente + 1 Ebenen)
